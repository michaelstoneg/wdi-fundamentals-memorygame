...
function createCards() {
  ...
  //for (var i = 0; i< cards.length; i++) {
		...
		cardElements.addEventListener('click', isTwoCards, cardImages);
	}
}
...
//}
function cardImages() {
	if (document.getAttribute('data-card') === 'king') {
		this.innerHTML = '<img src="images/king.png">';
	}
	else if (document.getAttribute('data-card') === 'queen') {
		this.innerHTML = '<img src="images/queen.pgn">';
	}
}
